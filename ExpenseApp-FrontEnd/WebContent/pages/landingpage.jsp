...
<body>
		...
		<div class="login-signup-container">
			<div class="login-container">
				<div class="heading-container">
					<img alt="login" src="<%= request.getContextPath() %>/images/login.png">
					<h2>Login</h2>
				</div>
				...
				<div class="login-circle-button" onclick="loginOnclick()">
					<img alt="arrow-up" src="<%= request.getContextPath() %>/images/arrow-up.png">
				</div>
			</div>
			<div class="signup-container">
				<div class="heading-container">
					<img alt="signup" src="<%= request.getContextPath() %>/images/signup.png">
					<h2>Signup</h2>
				</div>
				<form name="signup-form" onsubmit="return signupFormValidate();"
					...
					<div class="form-container">
						<input type="text" name="username"
							placeholder="Enter a username.." class="input"> 
					<input
 ...
 --%>
	...
	<div class="app-features-card-container col-sm-12 col-md-12 col-lg-12">
		<div
			...
			<div class="scroll-msg-container__arrow">
				<img alt="scroll-arrow"
					src="<%= request.getContextPath() %>/images/scroll-arrow.png">
			</div>
		</div>
		<div
			class="app-features-card-container__feature-card col-sm-4 col-md-4 col-lg-4">
			<img alt="manage-expense"
				src="<%= request.getContextPath() %>/images/coin-wallet.png">
		...
		<div
			class="app-features-card-container__feature-card col-sm-4 col-md-4 col-lg-4">
			<img alt="split-bill" src="<%= request.getContextPath() %>/images/split-bill.png">
			<div class="feature-card__feature-info">Going out for lunch
				with friends? Split the bill without any hassle!</div>
		</div>
		<div
			class="app-features-card-container__feature-card col-sm-4 col-md-4 col-lg-4">
			<img alt="analyse" src="<%= request.getContextPath() %>/images/analyse.png">
