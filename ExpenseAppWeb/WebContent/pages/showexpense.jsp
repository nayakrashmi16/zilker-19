...
<link rel="stylesheet" href="./../ExpenseAppWeb/css/showexpense.css">
<link rel="stylesheet"
...
<body>
				...
				<ul class="sidebar-options">
					<div class="sidebar-options-container">
						<li class="sidebar-option"><a class="nav-link"
							href="../../ExpenseAppWeb/pages/myexpense.jsp">My Expenses</a></li>
						<li class="sidebar-option"><a class="nav-link" href="#">Group
								Expenses</a></li>
			...
			<div class="navbar__nav-options col-sm-6 col-md-6 col-lg-6">
				<ul class="nav-options__nav-options-list">
					<li class="nav-options-list__nav-option nav-option-active"><img
						src="../../ExpenseAppWeb/images/rupee.png" alt="coin"
						class="nav-option__icon"> <a class="nav-link-active"
						href="../../ExpenseAppWeb/pages/myexpense.jsp">My Expenses</a></li>
					<li class="nav-options-list__nav-option"><img
						src="../../ExpenseAppWeb/images/group.png" alt="group"
						class="nav-option__icon"> <a class="nav-link" href="#">Group
							Expenses</a></li>
					<li class="nav-options-list__nav-option"><img
						src="../../ExpenseAppWeb/images/statistic.png" alt="statistics"
	...
	<div class="page-content">
		<%
			for (Expense expense : (ArrayList<Expense>) request.getAttribute("expenseList")) {
				out.print("<div class='expense-list-container'>"
						...
						+ expense.getCreatedAt().toGMTString().substring(0, 11) + "</p>" + "</div>"
						+ "<div class='expense-preview-card__icon-container col-sm-1 col-md-1 col-lg-1'>"
						+ "<img src='/ExpenseAppWeb/images/" + expense.getType()
			...
			<form name="new-expense-form" class="form">
				...
				<div
					...
					<div
						...
						<img src="../../ExpenseAppWeb/images/food.png" alt="expense-type"
	...
	<script src="../../ExpenseAppWeb/js/showexpense.js"></script>
</body>
